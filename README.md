...
1. 'protoc' converts all primitive field' default values to decimal format, contrary to the spec; we don't. However, the resulting `FileDescriptor` and any its descriptors will have the identical values. See https://github.com/google/protobuf/issues/61
